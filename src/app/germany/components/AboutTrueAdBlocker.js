        ...
        <div className={styles.top}>
          <div className={styles.left}>
            ...
            <p>
              ...
              Spotify, YouTube, Hulu oder Twitch, jetzt können Sie Ihre
              Lieblingsinhalte ungestört ansehen. Es verbessert auch Ihre
              Privatsphäre und beschleunigt Ihre Webseite. Das Beste daran ist,
              dass die Nutzung kostenlos ist. Laden Sie also die Erweiterung
              herunter und installieren Sie sie, um ein schnelleres und
              reibungsloseres Erlebnis zu erzielen
            </p>
          </div>
