    ...
    <>
      <div className={styles.privacy}>
        <div className={styles.container}>
          <h2>Privacy Policy for Expert AdBlocker</h2>

          <div className={styles.content}>
            <div className={styles.item}>
              <h4>Log Files</h4>
              <p>
                Expert AdBlocker follows a standard procedure of using log
            ...
            <div className={styles.item}>
              ...
              <p>
                Like any other website, Expert AdBlocker uses
            ...
            <div className={styles.item}>
              ...
              <p>
                ...
                the advertising partners of Expert AdBlocker. Third-party ad
                servers or ad networks uses technologies like cookies,
                JavaScript, or Web Beacons that are used in their respective
                advertisements and links that appear on Expert AdBlocker, which
                are sent directly to users&apos; browser. They automatically
                receive your IP address when this occurs. These technologies are
                used to measure the effectiveness of their advertising campaigns
                and/or to personalize the advertising content that you see on
                websites that you visit. Note that Expert AdBlocker has no
            ...
            <div className={styles.item}>
              ...
              <p>
                Expert AdBlocker&apos;s Privacy Policy does not apply to other
                ...
                browser&apos;s respective websites. What Are Cookies?
              </p>
            </div>
            <div className={styles.item}>
              ...
              <p>
                ...
                activity. Expert AdBlocker does not knowingly collect any
            ...
            <div className={styles.item}>
              ...
              <p>
                ...
                information that they shared and/or collect in Expert AdBlocker.
