    ...
    <div className={styles.footer}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.buttonContainer}>
          <Button text="Block All Ads Now - it's Free"></Button>
        ...
        <div className={styles.popularSearch}>
          ...
          <span>
            advertisement blocker chrome, abp plus chrome, adb plus chrome,
            browser chrome, youtube no ads, hulu without ads, adguard ablocker
            and Pop-up ads
          </span>
        </div>
