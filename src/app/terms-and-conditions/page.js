        ...
        <div className={styles.content}>
          ...
          <div className={styles.item}>
            ...
            <p>
              ...
              agreed to use cookies in agreement with the True AdBlocker&apos;s
              Privacy Policy
            </p>
          </div>
          <div className={styles.item}>
          ...
          <div className={styles.item}>
            ...
            <ul>
              ...
              <li>Reproduce, duplicate or copy material from True AdBlocker</li>
          ...
          <div className={styles.item}>
            <p>
              ...
              by sending an e-mail to True AdBlocker. Please include your name,
          ...
          <div className={styles.item}>
            <p>
              No use of True AdBlocker&apos;s logo or other artwork will be allowed
