          ...
          <div className={styles.content}>
            ...
            <div className={styles.item}>
              ...
              <p>
                ...
                AdBlocker. All intellectual property rights are reserved. You
                may access this from True AdBlocker for your own personal use
            ...
            <div className={styles.item}>
              <p>
                ...
                website. True AdBlocker does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of True AdBlocker,its agents
                and/or affiliates. Comments reflect the views and opinions of
                the person who post their views and opinions. To the extent
                permitted by applicable laws, True AdBlocker shall not be liable
            ...
            <div className={styles.item}>
              <p>
                ...
                of True AdBlocker; and (d) the link is in the context of general
